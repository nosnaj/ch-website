...
const IndexPage = () => (
  <>
    <SEO title="Home" />
    <div className={styles.openForMobile}>
      <div style={{ height: '80px' }} />
      <div className={styles.header}>
        <a href="https://www.instagram.com/codehumans/" target="_blank" style={{ textDecoration: 'none', color: '#FEC95B' }}>
          <img src={InstagramLogo} style={{ margin: 0, width: '64px' }} />
        </a>
        <p style={{ fontFamily: 'Raleway', fontSize: '32px', fontWeight: '600', lineHeight: '40px', color: 'white', letterSpacing: '3px' }}>
          Check us out in our Instagram!
        </p>
      </div>
    </div>
    <div className={styles.closeForMobile}>
